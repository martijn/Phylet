...
public static class LibraryPresentation
{
    ...
    public const string AlbumArtProfileId = "JPEG_TN";
    ...
    internal static LibraryImageFormat ResolveImageFormat(string filePath)
    {
        ...
        {
            ".png" => new LibraryImageFormat("image/png", PngDlnaContentFeatures),
            _ => new LibraryImageFormat("image/jpeg", JpegDlnaContentFeatures)
        };
    }
}
